 ...
 * 2. A Publisher will produce data only if subscriber requests events. Publisher can also produce 0 items.
...
public class PublisherSubscriptionSubscriberTest {
    ...
    @Test
    public void customPublisherWillProduceOnlyIfSubscriberRequests_Test() {
        PublisherImpl publisher = new PublisherImpl();
        SubscriberImpl subscriber = new SubscriberImpl();
